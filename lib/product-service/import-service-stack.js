...
class ImportServiceStack extends cdk.Stack {
    constructor(scope, id, tables, props) {
        ...
        createProductTopic.addSubscription(new aws_sns_subscriptions_1.EmailSubscription('yuliia_mykhaliak@epam.com'));
        ...
        catalogBatchProcessLambda.addEventSource(new aws_lambda_event_sources_1.SqsEventSource(catalogItemsQueue, {
            batchSize: 5,
        }));
