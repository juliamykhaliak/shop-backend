...
class AuthorizationServiceStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        const basicAuthorizerLambda = new aws_lambda_nodejs_1.NodejsFunction(this, "basicAuthorizer", {
        ...
        this.basicAuthorizer = lambda.Function.fromFunctionArn(this, "BasicAuthorizerExport", basicAuthorizerLambda.functionArn);
